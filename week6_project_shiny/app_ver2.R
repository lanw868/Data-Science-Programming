...
tagNames_list = c("女子","山水","友情","月亮","冬天","生活","抒情","抒懷",
                  "孤獨","思念","思鄉","秋天","哲理","唐詩三百首","宮怨",
                  "送別","詠史懷古","詠物","愛情","閨怨","寫人","寫景",
                  "樂府","戰爭","離別","懷人","懷古","邊塞") 
authorNames_list = c("元結","元稹","王之渙","王昌齡","王勃","王建","王維",
...
server <- function(input, output) {
  ...
  output$Plotly_KM1 <- renderPlotly({
    ...
    kmeansData_author = pcat_tag$x[,1:2]
